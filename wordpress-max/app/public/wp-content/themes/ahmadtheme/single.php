	...
	<body class="single is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						<h1><a href="<?php echo get_template_directory_uri(); ?>/index.html">GreenTech Solutions</a></h1>
						<nav class="links">
							<ul>
					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								...
								<span class="image featured"><img src="<?php echo get_template_directory_uri(); ?>/images/pic01.jpg" alt="" /></span>
